...
from dotplot import get_lines_from_file, check_fasta_lines, get_sequence_from_fasta_lines, create_matches_table, filter_matches, ascii_filter, find_palindromes, create_complement_table, merge_tables
